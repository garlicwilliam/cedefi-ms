...
import {
  cedefiMenus,
  resetPassMenus,
} from "./components/menus/cedefi-menus.tsx";
              ...
              >
                <Routes>
                  ...
                  >
                    ...
                    <Route path={"/nav_snapshots"}>
                      <Route index element={<NavList />} />
                    </Route>
                    <Route path={"/rate_snapshots"}>
                      <Route index element={<RateList />} />
                    </Route>
                    <Route path={"/assets_snapshots"}>
                    ...
                    <Route path={"/profit_allocation_ratios"}>
                      ...
                      <Route
                        ...
                        element={<CreateProfitAllocationRatio />}
                      />
                    </Route>

                    <Route
                      path={"/acc_profit_user"}
                      element={<UserProfitList />}
                    />
                    <Route
                      path={"/acc_profit_platform"}
                      element={<PlatformProfitList />}
                    />
                    <Route
                      path={"/acc_profit_team"}
                      element={<TeamProfitList />}
                    />
                    ...
                    <Route path={"/profit_reallocations"}>
                      ...
                      <Route
                        path={"create"}
                        element={<CreateProfitReallocation />}
                      />
                    </Route>
                    ...
                    <Route path={"/profit_withdrawals"}>
                      ...
                      <Route
                        path={"create"}
                        element={<CreateProfitWithdrawal />}
                      />
                    </Route>
