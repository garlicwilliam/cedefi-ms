        ...
        <Table.Column
          ...
          render={(_, record: BaseRecord) => (
            <Space>
              ...
              <EditButton hidden={record.isSuper} size="small" recordItemId={record.id}>
                编辑
              </EditButton>
              ...
              <UpdateButton
                ...
                icon={record.suspended ? <CheckCircleOutlined /> : <CloseCircleOutlined />}
              >
              ...
              <UpdateButton
                ...
                size={'small'}
                recordItemId={record.id}
                meta={{ method: 'patch', subPath: 'reset' }}
                values={{}}
                confirmOkText={'确认'}
                confirmCancelText={'取消'}
                icon={<ToolOutlined />}
