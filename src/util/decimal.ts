...
export class SldDecimal {
  ...
  public isFloat(): boolean {
    ...
    } else if (this.e18BigNumber !== null) {
  ...
  public toOrigin(): bigint {
    ...
    return this.originBigNumber !== null ? this.originBigNumber : 0n;
  }
  ...
  public sub(sldDecimal: SldDecimal): SldDecimal {
    if (this === SldDecimal.ZERO || this.isZero()) {
      return SldDecimal.fromE18(-sldDecimal.toE18(), sldDecimal.getOriginDecimal());
    }
  ...
  private originToE18() {
    ...
    const offset: number = 18 - this.originDecimal;

    this.e18BigNumber =
      offset > 0 ? this.originBigNumber * baseBigInt(offset) : this.originBigNumber / baseBigInt(-offset);
  }
  ...
  private e18ToOrigin() {
    ...
    this.originBigNumber =
      offset > 0 ? this.e18BigNumber / baseBigInt(offset) : this.e18BigNumber * baseBigInt(-offset);
  }
...
export class SldUsdValue {
  ...
  public add(val: SldUsdValue): SldUsdValue {
    ...
    return SldUsdValue.fromE18(this.toE18() + val.toE18(), this.tokenOriginDecimal);
  }
...
export class SldDecPercent {
  ...
  public div(divisor: bigint): SldDecPercent {
    const dec = SldDecimal.fromE18(this.toE18() / divisor, this.originDecObj.getOriginDecimal());
    return SldDecPercent.fromDecimal(dec);
  }
