...
import { FilterTypes, isTxHash } from './util.tsx';
    ...
    <List canCreate={true}>
      <Table {...tableProps}>
        ...
        <Table.Column
          ...
          title={'Withdraw From'}
          render={(from, row) => {
            return getFromType(from, row.portfolioId, teamMap, portfolioMap);
          }}
          filters={FilterTypes}
        />
        ...
        <Table.Column
          ...
          filterDropdown={() => {
            return (
              <SnapshotAtFilter fieldName={'transactionTime'} filters={filters} setFilters={setFilters} />
            );
          }}
        />
