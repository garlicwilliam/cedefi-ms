export const AbiThreeDaysDelayTimelockController: any[] = [
  {
    inputs: [
  ...
  {
    inputs: [{ internalType: 'bytes32', name: 'predecessorId', type: 'bytes32' }],
  ...
  },
  {
    ...
    outputs: [{ internalType: 'enum TimelockController.OperationState', name: '', type: 'uint8' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
